...
export const AQUAVO_SEO_RELEASE_LASTMOD = "2026-09-24";

export const AQUAVO_ENTITY = Object.freeze({
  brandName: "AQUAVO",
  arabicName: "أكوافو",
  legalName: "محل المنبع — AL NABEA SHOP",
  description: "AQUAVO متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة والمياه العذبة، مع توصيل إلى جميع محافظات العراق.",
  alternateNames: ["أكوافو", "اكوافو", "AQUAVO Iraq", "AQUAVO IQ"] as const,
  websiteAlternateNames: ["أكوافو", "اكوافو", "AQUAVO Iraq", "AQUAVO IQ", "aquavoiq.com"] as const,
  ...
  onlineOnly: true,
  returnPolicyUrl: `${AQUAVO_BASE_URL}/return-policy`,
  shippingPolicyUrl: `${AQUAVO_BASE_URL}/shipping`,
  knowsAbout: [
