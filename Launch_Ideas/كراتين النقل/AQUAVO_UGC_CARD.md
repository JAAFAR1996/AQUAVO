...
> **📊 مبني على أبحاث:**
> - 80% من الزبائن يثقون بـ UGC أكثر من الإعلانات التقليدية
> - QR codes تزيد التفاعل 300%+ مقارنة بالروابط المكتوبة
> - بطاقة واحدة بتصميم ذكي = إعلان مجاني لا نهائي
...
| المواصفة | التفاصيل |
|----------|----------|
| **القياس** | 100×100mm — **مربع!** ← يبرز بين المستطيلات + شكل پوست إنستغرام |
| **الخامة** | 350gsm (ثخين بالأيد — يحس إنه مهم) |
| **التشطيب (أمام)** | Soft-Touch مطفي + **Spot UV** على الصورة والشعار |
| **التشطيب (خلف)** | مطفي كامل (سهل القراءة) |
| **الزوايا** | مدورة 3mm (مافي حواف حادة — يحتفظ بيها) |
| **التكلفة** | $0.08-0.12/بطاقة عند 500+ |
...
### التصميم:
- **خلفية:** صورة حوض أكواسكيب مذهل (full bleed — تغطي كل البطاقة)
- **تأثير:** طبقة تدرج شفاف كحلي من الأسفل (gradient overlay) عشان النص يبان
- **الشعار:** AQUAVO + سمكة اللانهاية — أعلى اليمين بالأبيض (Spot UV يلمع!)
- **الصورة:** Spot UV على الحوض — يلمع عند إمالة البطاقة!
...
╔════════════════════════════════════════╗
║                                        ║
║       [صورة حوض أكواسكيب مذهل]         ║
║       [Full Bleed — تغطي الكل]         ║
║                                        ║
║                          ∞🐟 AQUAVO    ║
║                                        ║
║                                        ║
...
### ⚙️ قرارات التصميم (مبنية على البحث):
...
## 🎨 AI Prompts — بروموتات التوليد

---

### بروموت 1 — الوجه الأمامي (مع النص العربي)
...
```json
{
  ...
  "reference_image": {
    "instruction": "استخدم صورة اللوگو المرجعية المرفقة (AQUAVO logo) بالضبط كما هي — لا تغيّرها ولا تولّد لوگو جديد. انسخ اللوگو من الصورة المرجعية وحطّه على البطاقة.",
    "instruction_en": "Use the EXACT logo from the attached reference image. Do NOT generate or modify the logo — copy it precisely as shown in the reference. The logo is an infinity-fish symbol with 'AQUAVO' text below it.",
    "logo_file": "aquavo-logo-print.png",
    "logo_description": "Infinity symbol (∞) shaped like a fish — left loop is a teal (#22B8C2) fish with a visible eye, right loop is a dark navy (#0A1F3B) leaf shape. Below: 'AQUAVO' in dark navy Montserrat Bold uppercase. The two loops intertwine elegantly."
  },
  ...
  "arabic_text_specs": {
    "headline": {
      ...
      "position": "Centered horizontally on the navy gradient area, upper portion of text zone",
      "direction": "RTL (right-to-left)",
      "effect": "Slight text-shadow: 0 1px 3px rgba(0,0,0,0.5) for readability on photo"
    },
    "subtitle": {
      "text": "حوضك ممكن يكون النجم الجاي على صفحتنا! 🌟",
      "font": "Cairo Regular",
      "size": "10pt equivalent (smaller, secondary)",
      "color": "rgba(255,255,255,0.85) (white with slight transparency)",
      "position": "Centered, below headline with 4mm spacing",
      "direction": "RTL"
    },
    "hashtag": {
      "text": "#حوضي_مع_اكوافو",
      "font": "Cairo SemiBold",
      "size": "9pt equivalent",
      "color": "#FFD700 (gold — stands out from white text)",
      "position": "Centered, below subtitle with 3mm spacing, near bottom of card",
      "direction": "RTL"
    },
    "logo": {
      "text": "AQUAVO",
      ...
      "size": "7pt",
      "color": "#FFFFFF",
      "position": "Upper-right corner, below infinity-fish logo icon"
    }
  },
  "composition": {
    "layout": "Top-down flat lay — square card as hero, phone and box as context",
    "card_orientation": "Square — mimicking Instagram post format",
    "focal_point": "The stunning aquascape photograph + bold Arabic headline",
    "text_hierarchy": "Eye flow: aquascape photo → Arabic headline → subtitle → gold hashtag"
  },
  "lighting": {
    "key_light": "Warm directional from upper-left — Spot UV areas catch light with glossy reflections",
    "mood": "Inspiring, aspirational, warm"
  },
  "color_palette": {
    "card_image": "Rich greens, natural wood browns, blue-red tetras",
    "gradient_overlay": "Navy #0A1F3B at 70% opacity fading up to transparent",
    "headline_text": "#FFFFFF pure white",
    "subtitle_text": "rgba(255,255,255,0.85)",
    "hashtag_text": "#FFD700 gold",
    "logo": "White with Spot UV shine",
    "surface": "Dark walnut wood"
  },
  "technical": {
    "resolution": "4K",
    "aspect_ratio": "1:1 card on 3:2 photo",
    "format": "PNG"
  },
  "constraints": {
    "must_include": [
      ...
      "iPhone showing Instagram nearby as context",
      "AQUAVO shipping box edge visible"
    ],
    "exclusions": ["English placeholder text on card", "coral reefs", "saltwater fish", "cheap print quality", "broken/garbled Arabic"],
    "critical_rules": [
      "Arabic text MUST be RIGHT-TO-LEFT and properly rendered",
      "The aquascape MUST be jaw-droppingly beautiful",
      "Text hierarchy: big headline → medium subtitle → small gold hashtag",
      "Gold hashtag creates visual contrast against white text — eye-catching",
      "If AI cannot render Arabic properly, leave text area as navy gradient with placeholder lines"
    ],
    "style_raw": true
  }
}
...
### بروموت 2 — الوجه الخلفي (مع النص العربي)
...
```json
{
  ...
  "arabic_text_specs": {
    "section_heading": {
      ...
      "size": "11pt",
      "color": "#0D7377 (teal)",
      "position": "Below logo, right-aligned (RTL), centered with margins"
    },
    "steps_title": {
      "text": "الخطوات بسيطة:",
      "font": "Cairo SemiBold",
    ...
    "reward_2": {
      "text": "🏷️ كود خصم ١٠٪ على طلبك الجاي",
      "font": "Cairo Regular",
      "size": "8pt",
      "color": "#0A1F3B"
    },
    "reward_3": {
      "text": "⭐ فرصة تفوز بـ \"حوض الأسبوع\" + هدية مجانية! 🎁",
      "font": "Cairo Regular",
      "size": "8pt",
      "color": "#0A1F3B"
    },
    "closing": {
      "text": "💙 كل حوض قصة... شنو قصتك؟",
      "font": "Cairo Medium Italic",
      "size": "8pt",
      "color": "#0D7377 (teal)"
    },
    "footer": {
      "text": "📱 @aquavo_iq  •  🌐 aquavoiq.com",
      "font": "Cairo Regular",
      "size": "7pt",
      "color": "#FFFFFF (white on teal bar)",
      "background": "Solid teal #0D7377 footer bar"
    }
  },
  "composition": {
  ...
  "lighting": {
    "key_light": "Soft even overhead — white card requires balanced illumination",
    "mood": "Clean, professional, easy to read"
  },
  "color_palette": {
    "background": "#FFFFFF white card",
    "accents": "#0D7377 teal",
    "heading_text": "#0D7377 teal (bold heading)",
  ...
  "constraints": {
    "must_include": [
      ...
      "Teal footer bar with white '@aquavo_iq'",
    ...
    "critical_rules": [
      "ALL text on card is Arabic (RTL) except '@aquavo_iq' and 'aquavo.iq'",
...
### بروموت 3 — فلات لاي: لحظة الاستلام (مع النص العربي على البطاقة)
...
```json
{
  ...
  "task_type": "generation",
  "reference_image": {
    "instruction": "استخدم صورة اللوگو المرجعية المرفقة (AQUAVO logo) بالضبط كما هي على الكرتونة والبطاقة.",
    "instruction_en": "Use the EXACT logo from the attached reference image on the mailer box and card. Do NOT generate or modify the logo.",
    "logo_file": "aquavo-logo-print.png",
    "logo_description": "Infinity symbol (∞) shaped like a fish — left loop is a teal (#22B8C2) fish, right loop is a dark navy (#0A1F3B) leaf. Below: 'AQUAVO' in navy Montserrat Bold."
  },
  ...
  "composition": {
    "layout": "Lifestyle desk scene — box, card, phone, aquarium in background",
    "story": "OPEN → DISCOVER CARD → LOOK AT TANK → GRAB PHONE → SHARE!",
    "focal_point": "The UGC card with Arabic text visible — sharp focus — bridge between package and action",
    "depth": "Card sharp → box medium → aquarium soft blur (bokeh)"
  },
  "lighting": {
    "key_light": "Natural daylight from window — cozy, authentic, warm",
    "aquarium_light": "Tank LED lights visible in background — green glow of planted tank"
  },
  "color_palette": {
    "box": "Teal #0D7377",
    "card": "Aquascape greens with navy bottom, white Arabic text, gold hashtag",
    "ambient": "Warm daylight tones",
    "aquarium": "Green planted tank glow in background"
  },
  "technical": {
    "resolution": "4K",
    "aspect_ratio": "4:3",
  ...
  "constraints": {
    ...
    "exclusions": ["blank card without text", "staged/fake feel", "dark moody lighting", "coral reefs", "garbled Arabic"],
    "critical_rules": [
      "Arabic text on card must be RIGHT-TO-LEFT and cleanly rendered",
      "Must feel AUTHENTIC — like a real customer moment",
      "The aquarium in background is KEY — shows 'I have a tank I could share!'",
      "Card is the bridge between package and action — Arabic headline draws the eye",
      "If AI cannot render Arabic clearly on the small card, show navy gradient with white text shapes suggesting Arabic script"
    ],
    "style_raw": true
  }
}
...
### بروموت 4 — النتيجة: ريبوست على إنستغرام (مع النصوص العربية على الشاشات)
...
```json
{
  ...
  "task_type": "generation",
  "reference_image": {
    "instruction": "استخدم صورة اللوگو المرجعية المرفقة (AQUAVO logo) بالضبط كما هي على البطاقة وشاشات التلفونات.",
    "instruction_en": "Use the EXACT logo from the attached reference image on the card and phone screens. Do NOT generate or modify the logo.",
    "logo_file": "aquavo-logo-print.png",
    "logo_description": "Infinity symbol (∞) shaped like a fish — left loop is a teal (#22B8C2) fish, right loop is a dark navy (#0A1F3B) leaf. Below: 'AQUAVO' in navy Montserrat Bold."
  },
  "prompt_narrative": "Split-screen lifestyle photograph showing the RESULT of the UGC card campaign. LEFT HALF: a hand holding an iPhone showing an Instagram post — a beautiful photo of a planted freshwater aquarium posted by a customer. The post shows: visible likes count (500+), the tag '@aquavo_iq' visible on the photo, and the Arabic hashtag '#حوضي_مع_اكوافو' visible in the caption area below the image. The phone screen shows engagement (red heart icon, comment bubble with number). RIGHT HALF: the same photo reposted on what appears to be the AQUAVO brand's Instagram Story — with a decorative star frame labeled '🏆 حوض الأسبوع' (meaning 'Tank of the Week') in Cairo Bold 14pt white text with gold star accents on a teal (#0D7377) banner overlay at the top of the story. The story also shows '@aquavo_iq' and the Arabic text 'مبروك! 🎉' (meaning 'Congratulations!') in Cairo SemiBold 12pt white at the bottom. Between the two phones (or below them): the original UGC square card that started it all, lying on the desk with its Arabic headline 'راوينا حوضك!' visible. The composition tells the complete cycle: 'Customer shared → Brand featured → Community celebrated!' Bright, optimistic, celebratory mood. Clean white desk surface. Natural lighting with warm tones. Confetti or sparkle elements optional. 4K resolution.",
  "arabic_text_specs": {
    "instagram_hashtag": {
      "text": "#حوضي_مع_اكوافو",
      "font": "System Arabic (iOS default) or Cairo Regular",
      "size": "As it appears on Instagram caption — approximately 8pt",
      "color": "#00376B (Instagram link blue)",
      "position": "Caption area of the Instagram post on left phone"
    },
    "story_banner": {
      "text": "🏆 حوض الأسبوع",
      "font": "Cairo Bold",
      "size": "14pt equivalent on Story",
      "color": "#FFFFFF white on teal (#0D7377) semi-transparent banner",
      "position": "Top of Instagram Story on right phone"
    },
    "story_congrats": {
      "text": "مبروك! 🎉",
      "font": "Cairo SemiBold",
  ...
  "composition": {
    "layout": "Split or side-by-side: customer post (left) → brand reshare Story (right)",
    "story": "SHARE → GET FEATURED → WIN! The complete UGC cycle",
    "hero": "Both phone screens showing the success cycle with Arabic engagement"
  },
  "technical": {
    "resolution": "4K",
    "aspect_ratio": "16:9",
  ...
  "constraints": {
    "must_include": [
      "iPhone showing Instagram post with '#حوضي_مع_اكوافو' hashtag visible",
      "'@aquavo_iq' tag visible on the post photo",
    ...
    "exclusions": ["English-only text", "dark mood", "saltwater/coral", "fake-looking screens", "garbled Arabic"],
    "critical_rules": [
      "Arabic text on phones must look NATURAL — as it would appear on real Instagram",
      "'حوض الأسبوع' banner is the aspirational payoff — make it prominent and beautiful",
      "The card between phones creates visual narrative: 'this card started the journey'",
      "Must feel celebratory and aspirational — a success story!",
      "If AI struggles with small Arabic on phone screens, keep it as recognizable Arabic script shapes"
    ],
    "style_raw": true
  }
}
...
| النوع | الهاشتاگ | الغرض |
|-------|---------|-------|
| **الأساسي (على البطاقة)** | `#حوضي_مع_اكوافو` | البطل — CTA الرئيسي |
| **البراند** | `#AQUAVO_IQ` | تتبع البراند |
| **المجتمع** | `#أحواض_العراق` | الوصول المحلي |
| **النيتش** | `#سمك_الزينة` `#اكواسكيب_عراقي` | SEO + اكتشاف |
...
| المقياس | التوقع |
|---------|--------|
| **نسبة المشاركة** | 8-15% من الزبائن (مع QR واتساب) |
| **متوسط بدون UGC card** | 1-3% فقط |
| **تكلفة البطاقة** | $0.08-0.12 |
| **قيمة كل UGC post** | $5-15 (إعلان مجاني!) |
| **ROI المتوقع** | 5,000-12,000% 🤯 |

**الحساب:** بطاقة بـ $0.10 → 10% يشاركون → كل مشاركة = إعلان مجاني بقيمة $5-15
→ كل 100 بطاقة ($10) = 10 posts = $50-150 قيمة إعلانية!

---

## 💰 التكلفة

| الكمية | تكلفة/بطاقة | يشمل |
|--------|-----------|------|
...
> **⚙️ آلية العمل:** نتابع الهاشتاگ `#حوضي_مع_اكوافو` + التاگ `@aquavo_iq` على إنستغرام.
...
*مبني على: SmartPress UGC Guide, Undigital Packaging Inserts, BazaarVoice UGC Research 2025*
