...
- السباحة مكلوبي/عكسية (مرض كيس الهواء): صوّم السمكة 24-48 ساعة كاملة. بعدها أعطها بازلاء مسلوقة مقشورة (حبة أو حبتين). تأكد من جودة الماء. الإفراط بالأكل هو السبب الأكثر شيوعاً. إذا ما تحسنت بعد 3 أيام، جرب معالج مضاد للبكتيريا.
- بقع بيضاء صغيرة على الجسم (Ich/جدري): ارفع الحرارة تدريجياً لـ 28-30°C + أضف ملح طعام (ملعقة صغيرة لكل 10 لترات) + معالج Ich. العلاج 5-7 أيام.
- تعفن الزعانف أو الذيل (Fin Rot): غير 30% من الماء فوراً + معالج مضاد للبكتيريا (ميثيلين بلو أو erythromycin). نظافة الماء هي الأساس.
- فطريات بيضاء كقطن: معالج فطريات + ملح طعام. عزل السمكة إذا ممكن.
...
[طوارئ الحوض - خطوات فورية]
- انقطاع الكهرباء والفلتر توقف:
  1. لا تطعم الأسماك نهائياً (الأكل يستهلك الأكسجين)
  2. حرك الماء يدوياً بملعقة كل 30-60 دقيقة لتهوية السطح
  3. إذا صار أكثر من ساعتين: استخدم مضخة هواء ببطاريات إذا عدك
  4. إذا صار 4 ساعات أو أكثر: ضع كيس ثلج صغير لتبريد الحرارة (الحرارة العالية تقلل الأكسجين)
  5. عند رجوع الكهرباء: إذا الفلتر وكف 4+ ساعات، اغسله قبل تشغيله (الباكتيريا الميتة تسبب أمونيا). أضف مزيل أمونيا كإسعاف أولي.
