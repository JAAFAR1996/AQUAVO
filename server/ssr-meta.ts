  ...
  if (requestPath === "/guides/aquarium-decor-stones-guide") {
    ...
    jsonLdScripts.push({
      ...
      "mainEntity": [
        ...
        { "@type": "Question", "name": "هل AQUAVO يبيع ديكور وأحجار أحواض الزينة في العراق؟", "acceptedAnswer": { "@type": "Answer", "text": "نعم. AQUAVO متجر معدات ومستلزمات أحواض الزينة في العراق يوفر ديكورات وأحجاراً آمنة ومختبرة، مع توصيل 5,000 دينار لكل المحافظات والدفع عند الاستلام أو إلكترونياً." } }
      ]
    });
    jsonLdScripts.push({
      "@context": "https://schema.org",
