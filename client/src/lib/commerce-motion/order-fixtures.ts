// Safe fixture data for the Preview Order-Success (Idea B) simulation.
//
// NEVER creates a real order — no API call, no stock/DB mutation. Product
// names/prices/images are real AQUAVO catalogue items (the brand's own assets)
// so the simulation reads authentically. The order number is an obvious SIM value.
