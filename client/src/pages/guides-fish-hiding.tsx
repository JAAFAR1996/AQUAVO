    ...
    <div className="g-wrap">
      ...
      <style>{`
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0}
        ...
        .g-cause-header{display:flex;align-items:baseline;gap:14px;margin-bottom:18px;border-bottom:1px solid rgba(25,155,184,.2);padding-bottom:10px}
        ...
        .g-safe{background:rgba(25,155,184,.06);border:1px solid rgba(25,155,184,.22)}
        ...
        .g-safe .g-diag-label{color:#199BB8}
        ...
        .g-safe .g-diag-list li::before{content:"—";position:absolute;right:0;color:rgba(25,155,184,.6)}
        .g-warn .g-diag-list li::before{content:"—";position:absolute;right:0;color:rgba(255,108,71,.6)}
        .g-table-wrap{overflow-x:auto;border-radius:12px;border:1px solid rgba(25,155,184,.15)}
        .g-table{width:100%;border-collapse:collapse;font-size:13px;min-width:520px}
        .g-table th{background:rgba(25,155,184,.1);color:#199BB8;padding:10px 14px;text-align:right;font-weight:700;font-size:12px;letter-spacing:.3px}
        ...
        .g-table tr:hover td{background:rgba(25,155,184,.04)}
        .g-td-safe{color:rgba(25,155,184,.85)!important;font-weight:600}
        ...
        .g-info-note{background:rgba(25,155,184,.06);border-right:3px solid rgba(25,155,184,.5);border-radius:0 10px 10px 0;padding:12px 16px;font-size:13px;color:#8acad8;line-height:1.6;margin-top:14px}
        ...
        .g-send-footer{background:rgba(25,155,184,.08);border:1px solid rgba(25,155,184,.2);border-radius:10px;padding:12px 16px;font-size:14px;color:#199BB8;font-weight:600;text-align:center}
