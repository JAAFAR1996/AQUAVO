  ...
  const categories: FAQCategory[] = [
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "رسوم التوصيل 5,000 دينار لكل العراق. التوصيل مجاني للطلبات فوق 100,000 دينار."
        },
        {
        ...
        {
          question: "هل تبيعون أسماك حية؟",
          answer: "لا، AQUAVO متخصص بمعدات ومستلزمات الأحواض فقط — فلاتر، سخانات، غذاء، ديكور، إضاءة، ومعالجة مياه. لا نبيع أسماكاً حية أو نباتات مائية."
        }
      ]
    },
    {
      ...
      faqs: [
        ...
        },
        {
          ...
          answer: "للطلبات الكبيرة، تواصل معنا عبر واتساب لمناقشة خيارات الدفع المتاحة."
        }
      ]
    },
    {
      ...
      faqs: [
        {
          ...
          answer: "إذا وصلك منتج تالف أو خاطئ، أبلغنا خلال 48 ساعة مع صور واضحة وسنستبدله مجاناً."
        },
        {
        ...
        },
        {
          ...
          answer: "بعد التأكد من حالة المنتج، يتم الاستبدال أو الاسترداد خلال 24-48 ساعة."
        },
        {
    ...
    },
    {
      ...
      faqs: [
        ...
        {
          question: "هل توفرون أسماك زينة؟",
          answer: "المتجر الإلكتروني متخصص بمعدات ومستلزمات الأحواض. للأسماك الحية داخل بغداد، تواصل معنا عبر واتساب."
        },
        {
