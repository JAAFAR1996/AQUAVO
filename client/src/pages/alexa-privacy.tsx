              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>
                    ...
                    required to operate the integration (Amazon's own Alexa/LWA services and the
                    hosting used to run our own server). No other third party ever receives this
                    data.
                  </li>
                </ul>
              </CardContent>
              ...
              <CardContent className="p-6">
                ...
                <ul className="space-y-2 text-muted-foreground">
                  ...
                  <li>
                    ...
                    التكامل (خدمات أمازون Alexa/LWA نفسها، والاستضافة المستخدمة لتشغيل خادمنا).
                    لا يستلم أي طرف ثالث آخر هذه البيانات على الإطلاق.
                  </li>
                </ul>
              </CardContent>
            </Card>
