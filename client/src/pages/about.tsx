...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col bg-background font-sans">
      <MetaTags
        title="من نحن - AQUAVO"
        description="AQUAVO هو أول متجر اونلاين متخصص في أسماك الزينة ومستلزمات الأحواض في العراق. تأسسنا في بغداد عام 2024 بهدف توفير أفضل المنتجات لهواة الأسماك في كل محافظات العراق. تشكيلة مختارة من معدات الأحواض الأصلية مع توصيل لكل المحافظات ودعم فني 24/7."
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-speakable>
                ...
                نوفر تشكيلة متخصصة من المنتجات الأصلية تشمل الأحواض، الفلاتر، السخانات، الإضاءة، الأغذية، العلاجات، والنباتات المائية، 
                مع دعم فني مجاني ومتخصص على مدار الساعة.
              </p>
            </motion.div>
          </div>
        </section>
        ...
        <section className="py-16">
          <div className="container mx-auto px-4 max-w-4xl">
            ...
            <div className="prose prose-lg dark:prose-invert max-w-none text-right space-y-4">
              ...
              <p>
                اليوم، AQUAVO يخدم هواة الأسماك في كل محافظات العراق الـ 18، مع تشكيلة متخصصة من منتجات بريميوم 
