...
export default function About() {
  return (
    <div className="min-h-screen flex flex-col bg-background font-sans">
      <MetaTags
        title="من نحن - AQUAVO"
        description="AQUAVO هو أول متجر اونلاين متخصص في مستلزمات أحواض الزينة في العراق. تأسسنا في بغداد عام 2024 بهدف توفير أفضل المعدات لهواة الأحواض في كل محافظات العراق. تشكيلة مختارة من الفلاتر والسخانات والإضاءة والأغذية مع توصيل لكل المحافظات ودعم فني 24/7."
          ...
          <div className="container mx-auto px-4 text-center">
            ...
            >
              ...
              <h1 className="text-4xl md:text-6xl font-extrabold mb-6 leading-tight" data-speakable>
                <span className="text-primary">AQUAVO</span> — وجهتك الأولى{" "}
                <span className="text-accent">لمعدات أحواض الزينة</span> في العراق
              </h1>
              ...
              <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed" data-speakable>
                AQUAVO (اكوافو) هو أول وأكبر متجر إلكتروني متخصص في مستلزمات أحواض الزينة في العراق.
                تأسس في بغداد عام 2024، ويخدم هواة الأحواض في جميع المحافظات العراقية الـ 18 مع توصيل سريع وأسعار منافسة.
                نوفر تشكيلة متخصصة من المنتجات الأصلية تشمل الأحواض، الفلاتر، السخانات، الإضاءة، الأغذية، والعلاجات،
