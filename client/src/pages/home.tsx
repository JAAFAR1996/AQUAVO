    ...
    <div className="min-h-screen overflow-x-hidden bg-background text-foreground">
      ...
      <main id="main-content" dir="rtl">
        <section className="aq-waterline-hero relative isolate overflow-hidden border-b border-white/10 bg-[#06141d] pt-24 sm:pt-28">
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 pb-12 pt-8 sm:px-6 sm:pb-16 lg:grid-cols-[1.02fr_0.98fr] lg:gap-16 lg:px-8 lg:pb-20 lg:pt-12">
            <div className="aq-hero-copy order-2 text-right lg:order-1">
              ...
              <h1 className="aq-hero-title max-w-3xl font-heading text-[2.55rem] font-bold leading-[1.12] text-white sm:text-5xl lg:text-[3.55rem]">
        ...
        <section aria-label="معلومات الخدمة" className="border-b border-border/60 bg-card/35">
          <PrecisionReveal stagger className="mx-auto grid max-w-7xl grid-cols-2 gap-px bg-border/50 sm:grid-cols-4">
          ...
          <div className="mt-9 grid gap-3 sm:grid-cols-2 lg:grid-cols-3">
            {categories.map(({ title, description, href, icon: Icon }) => (
              <Link
                key={title}
                href={href}
                className="aq-interactive-card group flex min-h-40 items-start gap-4 rounded-2xl border border-border/70 bg-card/55 p-5 hover:border-primary/50 hover:bg-card focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
              >
              ...
              <div className="mt-8 grid grid-cols-2 gap-3 lg:grid-cols-4">
                {storePicks.map((product) => (
                  <Link
                    ...
                    className="aq-interactive-card overflow-hidden rounded-2xl border border-border/70 bg-background hover:border-primary/45 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                  >
        ...
        <section className="mx-auto max-w-7xl px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
          <PrecisionReveal stagger className="grid gap-8 lg:grid-cols-[0.75fr_1.25fr] lg:items-end">
            <div>
            ...
            <div className="grid gap-3 sm:grid-cols-3">
              {guides.map((guide) => (
                <Link
                  key={guide.href}
                  href={guide.href}
                  className="aq-interactive-card group flex min-h-56 flex-col rounded-2xl border border-border/70 bg-card/55 p-5 hover:border-primary/50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary"
                >
