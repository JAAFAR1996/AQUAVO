      ...
      <section style={{ border: "1px solid #1e3a5f", borderRadius: 14, padding: 16, background: "#0B1E28" }}>
        <div style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap", alignItems: "center" }}>
          ...
          <div style={{ display: "flex", gap: 8, alignItems: "center", flexWrap: "wrap" }}>
            ...
            <div style={{ display: "grid", gap: 4, justifyItems: "start" }}><span style={{ color: "#67e8f9", fontSize: 10, fontWeight: 800, letterSpacing: 0.4 }}>PDF ENGINE · VECTOR V6</span><button onClick={() => void downloadPackagePdf()} disabled={!summary || pdfPending || (!isArchive && !balancesComplete)}
              ...
              {pdfPending
                ? pdfProgress?.stage === "rendering"
                  ...
                  : pdfProgress?.stage === "saving"
                    ? "جاري حفظ PDF..."
                    : "جاري تجهيز البيانات..."
                : "تنزيل التقرير المالي V6 · VECTOR"}
            </button></div>
          </div>
        </div>
