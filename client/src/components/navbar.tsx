...
export default function Navbar() {
  ...
  // Passive hook so any surface can request the cart to open (used by the preview
  // commerce-motion confirmation). Inert in Production — nothing dispatches it there.
  useEffect(() => {
