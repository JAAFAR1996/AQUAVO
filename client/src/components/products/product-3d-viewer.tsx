...
function DragOverlay({ visible }: { visible: boolean }) {
  return (
    ...
    >
      <div className="flex max-w-[290px] items-center gap-3 rounded-full border border-cyan-500/20 bg-card dark:bg-[#0B1E28]/85 px-4 py-2.5 shadow-[0_8px_32px_rgba(0,0,0,0.5)] backdrop-blur-md sm:max-w-md">
        <svg
        ...
        <svg
          className="h-5 w-5 shrink-0 text-foreground dark:text-white/95"
          fill="none"
          viewBox="0 0 24 24"
          stroke="currentColor"
          strokeWidth={1.8}
    ...
    return (
      <ViewerShell className={className} pieceCode={pieceCode}>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col items-center gap-3 text-foreground dark:text-white/60">
