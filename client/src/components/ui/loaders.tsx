...
const KEYFRAMES = `
  ...
  @keyframes aq-glow {
    0%, 100% { text-shadow: 0 0 18px rgba(11,147,166,.55), 0 0 36px rgba(11,147,166,.2); }
    50% { text-shadow: 0 0 28px rgba(11,147,166,.9), 0 0 56px rgba(11,147,166,.4), 0 0 80px rgba(13,232,255,.15); }
  }
      ...
      >
        <div
          style={{
            ...
            top: "-8%",
            left: "-8%",
            background: "radial-gradient(ellipse, rgba(11,147,166,.55) 0%, transparent 68%)",
            borderRadius: "50%",
        ...
        >
          <div
            style={{
              ...
              height: "100%",
              width: "32%",
              background: "linear-gradient(90deg, transparent, #0B93A6, #0de8ff, transparent)",
