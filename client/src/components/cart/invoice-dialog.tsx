    ...
    if (navigator.share) {
      try {
        await navigator.share({
          title: `Fish Web - ${orderData.orderNumber}`,
          text: shareText,
          ...
          <div className="bg-gradient-to-br from-primary via-primary to-blue-600 text-primary-foreground p-6 rounded-t-lg print:rounded-none">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h1 className="text-2xl font-bold">Fish Web</h1>
                  <p className="text-sm opacity-80">متجر مستلزمات الأحواض</p>
                </div>
              </div>
