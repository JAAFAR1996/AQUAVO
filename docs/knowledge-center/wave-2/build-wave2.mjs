...
const ID = "kc-wave2-articles-20260902";
const BACKUP = "blog_posts_backup_wave2_20260902";

const NEW = [
  {
    slug: "acclimating-new-fish",
    draft: "acclimation.html",
    category: "للمبتدئين",
    icon: "Droplet",
    title: "أقلمة السمكة الجديدة: ليش فتح الكيس يزيد الخطر",
    excerpt:
      "الكيس المغلق يحمي السمكة كيميائياً، وفتحه يرفع الـ pH فيحوّل الأمونيا الموجودة إلى صورتها السامة. الطريقة العملية، ونقطة الخلاف بين التنقيط والنقل السريع.",
  },
  {
    slug: "aquarium-test-kit-guide",
    draft: "test-kits.html",
    category: "علوم الأحواض",
    icon: "Activity",
    title: "قراءة اختبارات ماء الحوض: شنو يعني كل رقم",
    excerpt:
      "رقمان لازم يكونان صفراً دائماً، وواحد يُقرأ بالاتجاه لا بالقيمة. وليش قراءة الأمونيا وحدها بلا الـ pH والحرارة قد تخدعك تماماً.",
  },
  {
    slug: "gh-kh-water-hardness-guide",
    draft: "hardness.html",
    category: "علوم الأحواض",
    icon: "Beaker",
    title: "القساوة GH و KH و TDS: أي رقم يقرر ماذا؟",
    excerpt:
      "الـ KH يمنع الـ pH من الانهيار، والـ GH يحدد ملاءمة الماء للنوع، والـ TDS لا يعوّض عن أي منهما. وليش الاستقرار أهم من الرقم المثالي.",
  },
  {
    slug: "aquarium-salt-guide",
    draft: "salt.html",
    category: "مشاكل وحلول",
    icon: "AlertTriangle",
    title: "ملح الحوض: دواء بجرعة ومدة، لا مكمّل يومي",
    excerpt:
      "أسماك المياه العذبة لا تحتاج ملحاً روتينياً. الخطأ الذي يرفع التركيز بلا أن تشعر، ولماذا خلاف المصادر حول الأسماك عديمة الحراشف لا يمنع استنتاجاً عملياً.",
  },
];
...
fs.writeFileSync(path.join(HERE, "migration-wave2.sql"), lf(sql));
fs.writeFileSync(
  path.join(HERE, "rollback-wave2.sql"),
...
console.log(`emitted migration-wave2.sql (${NEW.length} inserts)`);
