...
const ID = "kc-wave4-articles-20260902";
const BACKUP = "blog_posts_backup_wave4_20260902";

const NEW = [
  {
    slug: "aquarium-shrimp-snails-guide",
    draft: "inverts.html",
    category: "أنواع الأسماك",
    icon: "Shell",
    title: "الروبيان والحلزون في الحوض: النحاس أولاً، ثم كل شيء آخر",
    excerpt:
      "اللافقاريات أحساس للنحاس بمراحل من الأسماك، والنحاس لا يتحلل بل يبقى في الركيزة لأشهر. ما تحتاجه فعلاً من الماء والفلتر والمخابئ.",
  },
  {
    slug: "schooling-fish-minimum-numbers",
    draft: "schooling.html",
    category: "أنواع الأسماك",
    icon: "Users",
    title: "الأسماك السربية: ليش ستة وليس ثلاثة؟",
    excerpt:
      "السرب آلية أمان لا زينة. السمكة السربية وحدها تعيش بتأهب دائم يضعف مناعتها، وشراء ثلاثة بدل ستة ليس توفيراً بل خسارة الثلاثة.",
  },
  {
    slug: "aquarium-care-while-traveling",
    draft: "travel.html",
    category: "للمبتدئين",
    icon: "Plane",
    title: "السفر وترك الحوض: الجوع أهون من الماء الفاسد",
    excerpt:
      "أكثر حوض يُفقد أثناء السفر لم يمت جوعاً بل من إفراط في العلف قبل المغادرة. جدول حسب مدة الغياب، وتحضير يبدأ قبل يومين لا قبل ساعة.",
  },
  {
    slug: "how-to-sex-aquarium-fish",
    draft: "sexing.html",
    category: "أنواع الأسماك",
    icon: "Fish",
    title: "تمييز الذكر من الأنثى: العلامات الموثوقة وحدود المعرفة",
    excerpt:
      "النسبة الخطأ بين الجنسين تسبب مطاردة مستمرة وتكاثراً غير مخطط. العلامات حسب النوع، والحالات التي لا يمكن الجزم فيها بصرياً.",
  },
];
...
fs.writeFileSync(path.join(HERE, "migration-wave4.sql"), lf(sql));
fs.writeFileSync(
  path.join(HERE, "rollback-wave4.sql"),
...
console.log(`emitted migration-wave4.sql (${NEW.length} inserts)`);
