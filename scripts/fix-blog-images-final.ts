...
// Map each post slug to the correct generated image
const imageMap: Record<string, string> = {
  ...
  "arowana-fish-care-guide-prices": "/blog-images/community.png",
  "feeding-fish-vegetables-cucumber-peas": "/blog-images/community.png",
  "can-fish-see-recognize-owners-science": "/blog-images/community.png",
  "freshwater-pufferfish-care-guide": "/blog-images/community.png",
  "turtles-with-aquarium-fish": "/blog-images/community.png",
  ...
  "aquarium-bedroom-feng-shui-sound-effect": "/blog-images/water-testing.png",
  ...
  "iraqi-summer-aquarium-cooling": "/blog-images/sick-fish.png",

  // CORAL REEF / SALTWATER
  "saltwater-vs-freshwater-aquarium-beginners": "/blog-images/coral-reef.png",

  // SHOPPING / AQUAVO
  "best-aquarium-store-iraq-2026": "/blog-images/community.png",
  "aquarium-fish-prices-iraq-2026": "/blog-images/community.png",
  "aquavo-vs-local-stores-baghdad": "/blog-images/community.png",
  "tetra-food-vs-budget-brands-comparison": "/blog-images/equipment.png",
  "avoid-fake-fish-stores-instagram-scams": "/blog-images/community.png",
  "ghazal-market-baghdad-fish-buying-tips": "/blog-images/community.png",
...
async function run() {
  console.log("Updating blog images with AI-generated images...");
  ...
  for (const post of posts) {
    ...
    if (newImage) {
      ...
      updated++;
      console.log(`🖼️ ${post.slug} -> ${newImage}`);
    } else {
      console.log(`⚠️ No image mapped for: ${post.slug}`);
    }
  }

  console.log(`\n🎉 Updated ${updated} post images with AI-generated photos!`);
  process.exit(0);
}
