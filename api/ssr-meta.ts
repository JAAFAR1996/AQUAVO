...
const STATIC_PAGES: Record<string, PageMeta> = {
  ...
  "/about": {
    title: "عن AQUAVO | متجر مستلزمات أحواض الزينة في العراق",
    description: "AQUAVO متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة والمياه العذبة، مع توصيل لجميع محافظات العراق ومحتوى عملي للهواة.",
    keywords: "AQUAVO، أكوافو، اكوافو، متجر مستلزمات أحواض الزينة في العراق، معدات أحواض السمك",
    jsonLd: [
      {
        "@context": "https://schema.org",
        "@type": "AboutPage",
        "@id": `${BASE}/about#page`,
        name: "عن AQUAVO",
        description: "AQUAVO متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة والمياه العذبة.",
        url: `${BASE}/about`,
      ...
      },
      {
        ...
        itemListElement: [
          { "@type": "ListItem", position: 1, name: "الرئيسية", item: BASE },
          { "@type": "ListItem", position: 2, name: "عن AQUAVO", item: `${BASE}/about` },
        ],
      },
    ],
  },
  "/why-aquavo": {
    title: "لماذا AQUAVO؟ | متجر مستلزمات أحواض الزينة في العراق",
    description: "تعرف على طريقة AQUAVO في عرض معدات ومستلزمات أحواض الزينة بمعلومات واضحة، مع توصيل لكل العراق ودفع عند الاستلام أو إلكترونياً.",
    keywords: "لماذا AQUAVO، متجر مستلزمات احواض العراق، مستلزمات احواض السمك، اكوافو",
    jsonLd: {
      "@context": "https://schema.org",
      "@type": "BreadcrumbList",
      itemListElement: [
