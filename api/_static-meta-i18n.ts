...
const CKB: Record<string, LocalizedStaticMeta> = {
  ...
  "/products": {
    title: "پێداویستییەکانی حەوزی ماسی لە عێراق — فلتەر، گەرمکەرەوە، خۆراک | AQUAVO",
    description: "هەموو پێداویستییەکانی حەوزی ماسی لە عێراق بکڕە: فلتەر، گەرمکەرەوە، خۆراک، چارەسەر، ڕووناکی LED، ڕازاندنەوە و زیاتر. براندی YEE و براندەکانی تر، نرخی ڕوون و گەیاندن بۆ هەموو پارێزگاکان.",
  },
  "/deals": {
  ...
  "/blog": {
    ...
    description: "وتار و ڕێنمایی پسپۆڕانە دەربارەی حەوزی ماسی لە عێراق: چاودێری کەرەستە، چارەسەری ئاو، فلتەر و گەرمکەرەوە، و ڕێوشوێنی کرداری بۆ سەرەتایی و شارەزا.",
  },
  "/guides": {
    title: "ڕێنماییەکانی AQUAVO بۆ حەوزی ماسی — چاودێری کرداری لە عێراق | AQUAVO",
    description: "ڕێنمایی هەنگاو بە هەنگاو بۆ ئامادەکردن و چاودێری حەوزی ماسی لە عێراق: فلتەر، گەرمکەرەوە، گۆڕینی ئاو، خۆراکدان، کەوز و هەڵە باوەکان.",
  },
  "/fish-encyclopedia": {
  ...
  "/calculators": {
    title: "ژمێرەرەکانی حەوزی ماسی — قەبارەی حەوز، فلتەر و گەرمکەرەوە بە خۆڕایی | AQUAVO",
    description: "ژمێرەری خۆڕایی بۆ خاوەن حەوز لە عێراق: قەبارەی حەوز، هێزی فلتەری پێویست، واتی گەرمکەرەوە، بڕی ئاو و ژمارەی ماسی گونجاو بۆ حەوزەکەت.",
  },
  "/fish-finder": {
  ...
  "/tank-builder": {
    ...
    description: "حەوزی ماسی نموونەییت هەنگاو بە هەنگاو ئۆنلاین دیزاین بکە. قەبارە، فلتەر، گەرمکەرەوە و ڕازاندنەوە لەگەڵ دیزاینەری زیرەکی AQUAVO عێراق هەڵبژێرە.",
  },
  "/aquarium-wizard": {
