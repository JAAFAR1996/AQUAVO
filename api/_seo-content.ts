...
export const SEO_META_OVERRIDES: Record<string, SeoMetaOverride> = {
  "/": {
    ...
    description: "AQUAVO متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة والمياه العذبة: فلاتر، سخانات، أغذية، إضاءة، ديكور ومعالجة مياه، مع توصيل لكل العراق.",
  },
  "/products": {
  ...
  "/shipping": {
    ...
    description: "تفاصيل توصيل AQUAVO داخل العراق، الدفع عند الاستلام أو إلكترونياً، ورسوم التوصيل الثابتة 5,000 دينار عراقي حسب السياسة المعتمدة.",
  },
  "/faq": {
    title: "الأسئلة الشائعة عن AQUAVO | مستلزمات أحواض الزينة",
    description: "إجابات مختصرة عن طلبات AQUAVO، التوصيل، الدفع عند الاستلام أو إلكترونياً، الإرجاع، والمنتجات الخاصة بمعدات ومستلزمات أحواض الزينة.",
  },
  "/return-policy": {
  ...
  "/about": {
    ...
    description: "تعرف على AQUAVO، متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة، مع توصيل لكل العراق ودفع عند الاستلام أو إلكترونياً.",
  },
  "/about-aquavo": {
    title: "عن AQUAVO | معدات ومستلزمات أحواض الزينة",
    description: "AQUAVO متجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض الزينة والمياه العذبة، مع توصيل لكل العراق ومحتوى عملي يساعد الهواة على الاختيار والصيانة.",
  },
  "/beginner-guide": {
  ...
  "/terms": {
    ...
    description: "الشروط والأحكام توضح قواعد استخدام موقع AQUAVO، الطلب، الدفع عند الاستلام أو إلكترونياً، التوصيل، وسياسات التعامل مع المنتجات.",
  },
  "/why-aquavo": {
    title: "لماذا AQUAVO؟ | مستلزمات أحواض الزينة",
    description: "تعرف على طريقة AQUAVO في اختيار معدات ومستلزمات أحواض الزينة، التعليم العملي، التوصيل لكل العراق، والدفع عند الاستلام أو إلكترونياً.",
  },
  "/guides/filter-choice": {
...
const SEO_CONTENT_PAGES: Record<string, SeoContentPage> = {
  "/products": {
    ...
    topic: "تصفح معدات ومستلزمات أحواض السمك وأحواض الزينة المتوفرة في العراق مثل الفلاتر، السخانات، الإضاءة، الغذاء، الديكور ومعالجات المياه",
    audience: "هذه الصفحة مناسبة لمن يبحث عن متجر مستلزمات أحواض السمك في العراق ويريد مقارنة المنتجات حسب الفئة قبل اختيار القطعة المناسبة لحجم الحوض واحتياجه",
  ...
  "/shipping": {
    h1: "التوصيل والدفع عند الاستلام أو إلكترونياً في العراق",
    topic: "معرفة طريقة توصيل طلبات AQUAVO داخل العراق ورسوم التوصيل والدفع عند الاستلام أو إلكترونياً",
  ...
  "/about": {
    h1: "من هو AQUAVO؟",
    topic: "تعريف AQUAVO كمتجر إلكتروني عراقي متخصص في معدات ومستلزمات أحواض السمك وأحواض الزينة والمياه العذبة",
    audience: "هذه الصفحة مناسبة لمن يريد يعرف هوية المشروع وطريقة عمله قبل الاعتماد عليه في شراء مستلزمات الحوض أو تجهيزه",
