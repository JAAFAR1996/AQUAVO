...
export const SEO_META_OVERRIDES: Record<string, SeoMetaOverride> = {
  "/": {
    description: "AQUAVO متجر عراقي لمعدات ومستلزمات أحواض الزينة: فلاتر، سخانات، أغذية، ديكور ومعالجات مياه، مع توصيل لكل العراق ودفع عند الاستلام أو إلكترونياً.",
  },
  "/products": {
