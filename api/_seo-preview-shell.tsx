...
export const SEO_FAQ_ITEMS = [
  [
    ...
    `نعم. AQUAVO متجر إلكتروني ويوصل الطلبات إلى ${AQUAVO_ENTITY.deliveryCoverage}. ${AQUAVO_ENTITY.deliveryPolicyNote}`,
  ],
  ["هل الدفع عند الاستلام متوفر؟", "نعم، طريقة الدفع المعتمدة هي الدفع النقدي عند الاستلام."],
  ["شلون أتواصل ويا دعم AQUAVO؟", AQUAVO_ENTITY.supportPolicyNote],
  ...
  return (
    <main id="main-content">
      <section className="aq-ssr-hero">
        ...
        <p>فلاتر، سخانات، أغذية، إضاءة، ديكورات ومعالجات مياه. التوصيل متاح لكل العراق، والدفع عند الاستلام، وتظهر أجرة ومدة التوصيل المتوقعة قبل تأكيد الطلب.</p>
...
function AboutPage() {
  return (
    <main id="main-content">
      ...
      <p>التوصيل متاح لكل العراق، والدفع عند الاستلام. تُعرض أجرة ومدة التوصيل المتوقعة قبل تأكيد الطلب، والدعم متاح عبر قنوات التواصل الرسمية حسب أوقات الخدمة.</p>
