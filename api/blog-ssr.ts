...
function blogSlugFromRequest(req: VercelRequest): { slug: string; url: string } | null {
...
export default async function handler(req: VercelRequest, res: VercelResponse): Promise<void> {
  ...
  try {
    ...
    // Vercel rewrites can change req.url. Restore the public article URL before
    // delegating so the existing stable SSR code resolves the real blog slug,
    // canonical URL, Article schema, title, description and publication dates.
