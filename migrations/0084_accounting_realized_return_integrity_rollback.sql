-- Safe rollback for 0084_accounting_realized_return_integrity.
-- Existing immutable inventory/return evidence is preserved. This restores only
-- the pre-0084 transition behavior and removes the deferred commit-time guard.
...
SET rolled_back_at=clock_timestamp(),
    notes=COALESCE(notes,'')||' | Rollback restored pre-0084 transition behavior; existing immutable return/inventory evidence preserved.'
WHERE version='0084_accounting_realized_return_integrity'
