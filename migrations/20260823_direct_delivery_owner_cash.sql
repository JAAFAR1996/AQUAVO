-- Direct AQUAVO delivery: courier keeps delivery fee, merchant net is received immediately.
-- External carriers remain unchanged and continue through carrier receivable/settlement flow.
...
BEGIN
  ...
  INSERT INTO public.payment_events(
    ...
    jsonb_build_object(
      ...
      'policy_version','v5_direct_delivery_owner_cash'
    ),
    'database_trigger'
  )
  ...
  INSERT INTO public.order_accounting_facts(
    ...
    'v5_direct_delivery_owner_cash',NEW.carrier,
    jsonb_build_object(
